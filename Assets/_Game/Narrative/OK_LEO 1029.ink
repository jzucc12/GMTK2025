...
+[Seller] "LEO is the leader in AI TECH!" What is so hard? 
-> Relationship_Puzzle
...
How can I help you?
+ [refund] Great. Transfering you now.
-> Wendys
+ [else] Aight, hold on. 
-> Options_Puzzle
...
-> Bloodtype
+ [wrong] Well "not" {player_Name}! You obviously don't need a refund!
-> Options_Puzzle 
...
+ [Bloodtype] -> BMI
+ [wrong] I said bloodtype, you fraud {player_Name}.
-> Options_Puzzle

===BMI===
~answer = "22.5"
I need your BMI?! 
What you did to get LEO so mad?!
+ [BMI] -> Uninstall
...
Hah!
-> Leo_Boss
+[incorrect] Darn coupon doen't work! 
